...
class MonitoringViewController: UIViewController, UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
...
//    var monitoringData:[[String]] = [["Blood Pressure","Glucose","Heart Rate","Cigarette","BMI","Cholesterol"] ,["Medicine Search","Top up","Reminder","Scan Medicine"]]
    var monitoringData:[String]=["Blood Pressure","Glucose","Heart Rate","Cigarette","BMI","Cholesterol","Medicine Search","Top up","Reminder","Scan Medicine"]
    var monitoringImages: [String] = ["redBloodPressure","blueGlucose","pinkheart","orangeCig","greenWeight","ruler","redBloodPressure","blueGlucose","pinkheart","orangeCig"]
...
//    [0x2196F3,0x2196F3,0x2196F3,0x2196F3]]
    ...
    var monitoringValue:[String] = ["140/80 mmHg","120 mgdL","110 bpm","10 cigs","28","80 mgdL","10","10","10","10"]
...
//       DesignViewResultsTodayButton()
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        //Reuse the cell
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "collection_cell", for: indexPath) as! MonitoringCollectionViewCell

        //Cell button action delegate
        cell.delegate = self as MonitoringCollectionViewCellDelegate
...
////Side Menu
//extension MonitoringViewController : SlideMenuControllerDelegate {
//
//    func leftWillOpen() {
...
extension MonitoringViewController: MonitoringCollectionViewCellDelegate{
    func didCellButtonTapped(cell: MonitoringCollectionViewCell) {
